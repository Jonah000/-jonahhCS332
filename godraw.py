...
class Paint:
    ...
    def setup_ui(self):
        ...
        self.layer_listbox.grid(row=1, column=3, sticky='nsew')
        ...
        self.lbl_status.grid(row=2, column=0, columnspan=4, sticky='ew')

        self.save_frame_button = Button(self.root, text="Save Frame", command=self.save_frame)
        self.save_frame_button.grid(row=5, column=0, sticky='ew')

        self.play_button = Button(self.root, text="Play Animation", command=self.play_animation)
        self.play_button.grid(row=5, column=1, sticky='ew')

        self.stop_button = Button(self.root, text="Stop Animation", command=self.stop_animation)
        self.stop_button.grid(row=5, column=2, sticky='ew')

        self.export_button = Button(self.root, text="Export GIF", command=self.export_as_gif)
        self.export_button.grid(row=5, column=3, sticky='ew')
        ...
        scrollbar.grid(row=3, column=5, rowspan=2, sticky='ns')
    ...
    def add_layer(self):
        ...
        new_canvas.grid(row=3, column=0, columnspan=4)
